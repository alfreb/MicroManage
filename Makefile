...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Mon Jun 17 17:01:25 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/microManage_server1.0.0/ && $(COPY_FILE) --parents micromachine.h micromanager.h qprocessmanager_simple.h qemuvm_qprocess.h experiment.h sampler.h ../perfdata/perfSampler.h ../perfdata/memDataPoint.h ../perfdata/cpuSample2.h outstream.h ../perfdata/scalingSample.h ../perfdata/globals.h .tmp/microManage_server1.0.0/ && $(COPY_FILE) --parents main.cpp micromachine.cpp micromanager.cpp qprocessmanager_simple.cpp qemuvm_qprocess.cpp experiment.cpp sampler.cpp ../perfdata/perfSampler.cpp ../perfdata/memDataPoint.cpp ../perfdata/cpuSample2.cpp ../perfdata/scalingSample.cpp .tmp/microManage_server1.0.0/ && (cd `dirname .tmp/microManage_server1.0.0` && $(TAR) microManage_server1.0.0.tar microManage_server1.0.0 && $(COMPRESS) microManage_server1.0.0.tar) && $(MOVE) `dirname .tmp/microManage_server1.0.0`/microManage_server1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/microManage_server1.0.0
