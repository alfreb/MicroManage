...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Fri Jun 14 14:06:24 2013
...
SOURCES       = main.cpp \
		...
		../perfdata/sample.cpp moc_micromachine.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/microManage_server1.0.0/ && $(COPY_FILE) --parents micromachine.h micromanager.h qprocessmanager_simple.h qemuvm_qprocess.h experiment.h sampler.h ../perfdata/perfSampler.h ../perfdata/memDataPoint.h ../perfdata/cpuSample2.h ../perfdata/sample.h outstream.h .tmp/microManage_server1.0.0/ && $(COPY_FILE) --parents main.cpp micromachine.cpp micromanager.cpp qprocessmanager_simple.cpp qemuvm_qprocess.cpp experiment.cpp sampler.cpp ../perfdata/perfSampler.cpp ../perfdata/memDataPoint.cpp ../perfdata/cpuSample2.cpp ../perfdata/sample.cpp .tmp/microManage_server1.0.0/ && (cd `dirname .tmp/microManage_server1.0.0` && $(TAR) microManage_server1.0.0.tar microManage_server1.0.0 && $(COMPRESS) microManage_server1.0.0.tar) && $(MOVE) `dirname .tmp/microManage_server1.0.0`/microManage_server1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/microManage_server1.0.0
...
sample.o: ../perfdata/sample.cpp ../perfdata/sample.h \
		../perfdata/cpuSample2.h \
		../perfdata/globals.h \
		../perfdata/memDataPoint.h \
		../perfdata/dataPoint.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sample.o ../perfdata/sample.cpp
