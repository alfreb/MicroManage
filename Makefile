...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Fri May 24 15:55:49 2013
...
SOURCES       = main.cpp \
		micromachine.cpp \
		qemuvm.cpp \
		micromanager.cpp moc_micromachine.cpp \
		moc_qemuvm.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/microManage_server1.0.0/ && $(COPY_FILE) --parents micromachine.h qemuvm.h micromanager.h .tmp/microManage_server1.0.0/ && $(COPY_FILE) --parents main.cpp micromachine.cpp qemuvm.cpp micromanager.cpp .tmp/microManage_server1.0.0/ && (cd `dirname .tmp/microManage_server1.0.0` && $(TAR) microManage_server1.0.0.tar microManage_server1.0.0 && $(COMPRESS) microManage_server1.0.0.tar) && $(MOVE) `dirname .tmp/microManage_server1.0.0`/microManage_server1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/microManage_server1.0.0
